...
clear all;
%ABRIR ARCHIVO 
archivo=fopen('C:\Users\karla\Downloads\TeoriadeLaInfo\P1\Libro_ING.txt','r');
...
xlabel('Caracteres');
ylabel('Probabilidad');
title(['Karla Robert - Distribución de Probabilidad de Caracteres sin Ñ']);
grid on;
...
title(['Karla Robert - Cantidad de Información por Caracter sin Ñ']);
grid on;
% --- mostrar valores encima ---
for i=1:length(I1)
